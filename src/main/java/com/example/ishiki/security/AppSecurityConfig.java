package com.example.ishiki.security;
import com.example.ishiki.filter.JwtValidationFilter;
    ...
    public SecurityFilterChain defaultFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/cards/**","/courses/**","/fields/**","/", "/users/**", "/register**", "/login**", "/verifyTotp**").permitAll()
